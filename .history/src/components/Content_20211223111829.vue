    ...
    <el-container>
        ...
        <el-menu default-active="2" unique-opened="true">
          ...
          <el-sub-menu index="2">
            ...
            <el-menu-item
              ...
              >成绩查询</el-menu-item
            >
            <el-menu-item index="2-3" @click="isShow(isShowUser)"
              >删除学生</el-menu-item
            >
      ...
      <el-container>
        <el-main>
          ...
          <student v-if="isShowStudent" />
          <charts v-if="isShowChart" />
          <score v-if="isShowScore" />
